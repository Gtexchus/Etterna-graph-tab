...
local function setXaxisLabelScale(newXaxisLabelScale) 
    xAxisLabelScale = newXaxisLabelScale
...
local function setYaxisLabelScale(newYaxisLabelScale)
    yAxisLabelScale = newYaxisLabelScale
...
if Var("XaxisLabelScale") then
    setXaxisLabelScale(Var("XaxisLabelScale")) --the scale of the x axis labels
elseif Var("XaxisLabelRound") then
    ...
    setXaxisLabelScale(notShit.floor((((maxXvalue - minXvalue)/maxNumOfAxisLabelsWhenRounding) / xAxisLabelRound) + 1) * xAxisLabelRound)
else
...
if Var("YaxisLabelScale") then
    setYaxisLabelScale(Var("YaxisLabelScale")) --the scale of y axis labels
elseif Var("YaxisLabelRound") then
    --copy and pasting code is my passion
    local yAxisLabelRound = Var("YaxisLabelRound")
    setYaxisLabelScale(notShit.floor((((maxYvalue - minYvalue)/maxNumOfAxisLabelsWhenRounding) / yAxisLabelRound) + 1) * yAxisLabelRound)
else
